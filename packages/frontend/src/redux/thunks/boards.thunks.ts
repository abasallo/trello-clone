...
export const fetchBoardsAsyncThunk = createAsyncThunk("boards/fetch",
    async (): Promise<Board[] | undefined> => await getBoards())

export const addBoardAsyncThunk = createAsyncThunk("boards/add",
    async (): Promise<Board | undefined> => await addBoard()
)

export const updateBoardAsyncThunk = createAsyncThunk("boards/update",
    async (board: Board): Promise<Board | undefined> => await updateBoard(board)
)

export const deleteBoardAsyncThunk = createAsyncThunk("board/delete",
