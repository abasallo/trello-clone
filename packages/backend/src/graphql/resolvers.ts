...
export const resolvers = {
  ...
  Mutation: {
    addBoard: (parent: never, args: { board: Board }): Promise<Board> => addBoard({ name: args.board.name, model }),
    deleteBoard: (parent: never, args: { id: number }): Promise<number> => deleteBoard({ id: args.id, model }),
